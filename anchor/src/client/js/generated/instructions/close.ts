...
export type CloseInput<
  ...
  TAccountTokenlotter extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountTokenlotter>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountTokenlotter> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.tokenlotter),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountTokenlotter>;
